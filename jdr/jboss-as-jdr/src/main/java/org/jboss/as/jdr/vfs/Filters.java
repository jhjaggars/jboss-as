...
public class Filters {
    ...
    public static VirtualFileFilter regexBlackList() {
        return new RegexBlacklistFilter();
    }

    public static VirtualFileFilter regexBlackList(String... patterns) {
    ...
    private static class RegexBlacklistFilter implements VirtualFileFilter{
